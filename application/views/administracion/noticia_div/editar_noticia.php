    ...
    <div class="col-md-9">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                    <?php echo form_open_multipart('', ['class' => '', 'id' => 'form', 'role' => 'form'], ['editar' => 1, 'ID_NOTICIA' => $id_noticia, 'TIPO' => $tipo, 'IMAGEN_NOTI' => $imagen_noti, 'TIPO_NOTICIA' => $tipo_noticia]); ?>
                    ...
                    <div class="form-group col-md-2 <?= (form_error($name) ? 'has-error has-feedback' : '') ?>">
                        <?php echo form_label($label, $name, ['class' => 'control-label']); ?>
                        <?php echo form_input(['id' => $name, 'name' => $name, 'maxlength' => 200, 'placeholder' => $tpo, 'class' => 'form-control'], set_value($tpo), 'disabled'); ?>
                    </div>
...
<!--                    </div>-->
                ...
                <span class="glyphicon glyphicon-calendar"></span>
                    ...
                    <?php if($tipo_noticia == '0') //Noticia del CECOM
                    { ?>
                    <?php $label = 'URL'; ?>
                    ...
                    <div
                        ...
                        <div>
                            <input class="form-control" accept="image/*,.pdf" type="file" name="<?php echo $name; ?>"/>
                        </div>
                        <?php echo $recomendacion; ?>
                    </div>
                    <?php }?>
