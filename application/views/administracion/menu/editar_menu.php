<div class="row no-margin margin-top-40">
    ...
    <div class="col-md-9">
        <h1 class="text-justify">Editar Menú</h1>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                    ...
                    <?php $label = 'Orden menú'; ?>
                    <?php $name = 'orden_menu_p'; ?>
        ...
        <a class="btn btn-primary pull-right margin-bottom-30" href="<?= site_url('administracion/menu'); ?>"
