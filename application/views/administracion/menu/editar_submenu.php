<div class="row no-margin margin-top-40">
    ...
    <div class="col-md-9">
        <h1 class="text-justify">Editar Submenú</h1>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                    ...
                    <?php $label = 'Menú padre'; ?>
                    <?php $name = 'padre_menu'; ?>
                    <div class="form-group col-md-12 <?= (form_error($name) ? 'has-error has-feedback' : '') ?>">
                        <?php echo form_label($label, $name, ['class' => 'control-label']); ?>
                        <select class="form-control" name="<?php echo $name; ?>" id="<?php echo $name; ?>">
                            <?php foreach ($menus_p as $menu_p): ?>
                                <option value='<?php echo $menu_p->id_menu;?>'><?php echo $menu_p->nombre_menu;?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
