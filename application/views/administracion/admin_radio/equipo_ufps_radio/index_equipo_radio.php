<div class="row no-margin margin-top-40">
    ...
    <div class="col-md-9">
        ...
        <a href="<?php echo site_url('administracion/equipo_ufps_radio_formulario/crear'); ?>" class="btn btn-primary pull-right">Crear Nuevo Integrante</a>
    </div>
</div>
