<div class="row no-margin margin-top-40">
    ...
    <div class="col-md-9">
    <h1 class="text-justify">Editar Popop</h1>
    <hr>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div>
                        <?php if (!empty($imagen_popop)): ?>
                            <img class="img img-bordered"
                                 src="<?php echo isset($imagen_popop) ? $imagen_popop : ""; ?>"
                                 width="500px;"/>
                        <?php else: ?>
                            <p>No existe una imagen asociada a este popop.</p>
                        <?php endif; ?>
                    </div>
                </div>
