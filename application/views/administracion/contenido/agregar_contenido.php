<div class="row no-margin margin-top-40">
    ...
    <div class="col-md-9">
        <h2 class="text-justify">Nuevo Contenido</h2>
        <hr>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 <?= (form_error($name) ? 'has-error has-feedback' : '') ?>">
                        ...
                        <select class="form-control" name="<?php echo $name; ?>" id="<?php echo $name; ?>"
                                onchange="validar_tipo_enlace()">
                            <option value=''>
                                Seleccione una opción
                            <option
                                value='0' <?php echo $this->input->post('sub_call_contenido') == '0' ? 'selected' : '' ?>>
                                No Actualizar
                            </option>
                            <option
                                value='1' <?php echo $this->input->post('sub_call_contenido') == '1' ? 'selected' : '' ?>>
                                Grupo de Trabajo - Administrativo
                            </option>
                            <option
                                value='2' <?php echo $this->input->post('sub_call_contenido') == '2' ? 'selected' : '' ?>>
                                Grupo de Trabajo - Docentes
                            </option>
                            <option
                                value='3' <?php echo $this->input->post('sub_call_contenido') == '3' ? 'selected' : '' ?>>
