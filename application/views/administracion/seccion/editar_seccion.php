<div class="row no-margin margin-top-40">
    ...
    <div class="col-md-9">
        <h1 class="text-justify">Editar Sección</h1>
        <hr>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                    <?php echo form_open_multipart('administracion/editar_seccion', ['class' => '', 'id' => 'form', 'role' => 'form'], ['editar' => 1]); ?>
                    <?php $label = 'Nombre'; ?>
        ...
        <input id="id_seccion" name="id_seccion" type="hidden" value="<?php echo $this->input->post('id_seccion');?>" />

        <a class="btn btn-primary pull-right margin-bottom-30" href="<?= site_url('administracion/seccion'); ?>"
            style="margin-left:10px;">
        <i class="fa fa-backward"></i> Regresar
        </a>
        <?php echo form_button(['content' => '<i class="fa fa-floppy-o"></i> Guardar Cambios', 'type' => 'button', 'id' =>'button_add' ,'class' => 'btn btn-primary pull-right']); ?>
        <?php echo form_close(); ?>
    </div>
</div>
<!-- Modal -->
