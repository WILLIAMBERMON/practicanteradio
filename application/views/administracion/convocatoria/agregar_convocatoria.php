<div class="row no-margin margin-top-40">
    ...
    <div class="col-md-9">
        <h1 class="text-justify">Nueva Convocatoria</h1>
        <hr>
                ...
                <div class="panel margin-top-30">
                    <div class="panel-heading panel-blue-ins">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <h3 class="panel-title"><b id="contenido_convocatoria"></b></h3>
                                <h6 style="color:#fff;"><i class="fa fa-calendar"></i> Publicado. <label id="fecha_convocatoria" style="color:#fff;"></label>
                                </h6>
                            </div>
                        </div>
                    </div>
