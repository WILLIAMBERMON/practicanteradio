<div class="row no-margin margin-top-40">
    ...
    <div class="col-md-9">
        <h2 class="text-justify">Editar Publicación</h2>
        <hr>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            <?php if (!empty($imagen_publicacion)): ?>
                                <img class="img img-bordered"
                                     src="<?php echo isset($imagen_publicacion) ? $imagen_publicacion : ""; ?>"
                                     width="85px;"/>
                            <?php else: ?>
                                <p>No existe una imagen asociada a esta publicación.</p>
                            <?php endif; ?>
                        </div>
                    </div>

                    <?php $label = 'Cambiar Imagen Portada'; ?>
                    ...
                    <?php $label = 'Cambiar Imagen Archivo'; ?>
        ...
        <a class="btn btn-primary pull-right margin-bottom-30" href="<?= site_url('administracion/publicacion'); ?>"
