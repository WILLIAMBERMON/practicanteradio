                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-5">
                        <a tabindex="-1" href="<?php echo base_url(); ?>">
                            <img tabindex="0" id="logo-header" style="max-height:150px" src="<?php echo base_url("/public/imagenes/template/header")."/03d8bc5aeb68472006822913303ff7af.png"; ?>" alt="Logo UFPS">
                        </a>
                    </div>
                    <div class="col-md-2 col-ms-1 col-xs-2 pull-right" style="padding-right:20%">
                        <a tabindex="-1" href="http://www.colombia.co/"><img tabindex="0" class="header-banner" style="max-height:130px" src="<?php echo base_url("/public/imagenes/template/header"). "/057d5adf167badd9519534241e2955da.png"; ?>" alt="Escudo de Colombia"></a>
                    </div>
                </div>
            </div>
        </div>
