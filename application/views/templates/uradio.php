...
<head>
    ...
    <title>Radio UFPS 95.2 - Cúcuta</title>

    <!-- Meta -->
    <meta charset="UTF-8">
    <meta name="application-name" content="UFPS" lang="es">
    <meta name="Author" content="Oficina de Prensa" lang="es">
    <meta name="Contributors" content="Viarney Alirio Villamizar Moreno" lang="es">
    <meta name="Aditional-Contributors" content="" lang="es">
...
<body class="header-fixed boxed-layout">
    ...
    <div class="wrapper">
        ...
        <?php include APPPATH . "views/uprincipal/header_navbar_radio.php"; ?>
    ...
    <!--/wrapper-->
    <!--=== Footer Version 1 ===-->
    <?php include APPPATH . "views/uprincipal/footer-vr.php"; ?>
