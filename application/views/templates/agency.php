    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Start Bootstrap <?php echo ((isset($noticiero[0]['idNoti'])) ? $noticiero[0]['idNoti'] : "-"); ?></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <?php echo ((isset($menu_principal_uno)) ? $menu_principal_uno : "-"); ?>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in"><?php echo ((isset($noticierobj[0]->titulo)) ? $noticierobj[0]->titulo : "-"); ?></div>
                <div class="intro-heading">Universidad Francisco de Paula Santander</div>
                <a href="#services" class="page-scroll btn btn-xl">Muy Pronto</a>
            </div>
        </div>
    </header>
