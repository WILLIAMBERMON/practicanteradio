                    ...
                    <ul class="list-unstyled" style="border-style: double; border-width: 6px; border-color: #ddd; padding: 10px; background-color: #f8f8f8;">
                        <li>
                            ...
                            <!-- <img class="img-responsive" src="<?php //echo base_url("public/imagenes/rectoria/hector_miguel_parra_lopez.jpg"); 
                                                                    ?>" alt=""> -->
                            <?php if (isset($inforectoria->ID_INFO_REC)):?>
                            <img class="img-responsive" src="<?php echo base_url('assets/uploads/img/rectoria/'.$inforectoria->FOTO);?>" alt="">

                            <!-- <h3><b>Héctor Miguel Parra López</b></h3> -->
                            <strong><h3><b><?php echo $inforectoria->NOMBRE;?></b></h3></strong>
                            <h4><?php echo $inforectoria->CARGO;?></h4>
        ...
        <div class="col-md-8 mb-margin-bottom-30">
            ...
            <div class="margin-bottom-40  fadeInUp animated">
                ...
                <?php if (isset($subcontenido[0]->idlici)) : ?>
                    ...
                    <?php $h = 0; ?>
                    <?php for ($i = 0; $i < $numFilas; $i++) : ?>
                        <?php $numeropubli = '01'; if ($subcontenido[$i]->grupo != $grupo) : ?>
                            ...
                            <?php endif; ?>
                            <li>
                                <?php if(isset($grupos) && $grupos){ foreach($grupos as $gr){
                                    if($gr->idgrupo == $subcontenido[$i]->grupo){
                                        $numeropubli =  ((intval($gr->numero))<10) ? ('0'.intval($gr->numero)):(intval($gr->numero));
                                    }
                                } }?>
                                ...
                                <a href="/public/archivos/rectoria/pdf/<?php echo ((isset($subcontenido[$i]->enlace)) ? $subcontenido[$i]->enlace : ""); ?>" target="_blank">
                                    ...
                                    No. <?php echo (($numeropubli) ? ($numeropubli) : ""); ?>
